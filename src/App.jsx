...
const GLOBAL_STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; user-select: none; -webkit-tap-highlight-color: transparent; }
  ...
  /* 🌟 RESTORED CIRCULAR SPLASH SCREEN 🌟 */
  ...
  @media (min-width: 769px) {
    ...
    .dock-item.active { background: #fff; color: #000; transform: translateX(12px) scale(1.1); box-shadow: -8px 8px 20px rgba(255,255,255,0.2); }
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Just a clean 2 second circular loading state
